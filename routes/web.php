...
// Route::get('/admin/data_notifikasi', [\App\Http\Controllers\LandingController::class,'adminKelolaNotifikasi'])->name('adminKelolaNotifikasi')->middleware('auth');


Route::get('/data_notifikasi', [\App\Http\Controllers\LandingController::class,'adminKelolaNotifikasi'])->name('adminKelolaNotifikasi')->middleware('auth');
